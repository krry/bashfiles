          ...
          if(data.areas[0].ridge != null) 
          {
            if(data.areas[0].tilt != null)
            {
              ...
              function showPrompt() {
                ...
                prompt("Copy to clipboard: Ctrl+C, Enter", mydata.areas[0].wkt + ' lat:' + mydata.map_details.center.lat + ' lng:' + mydata.map_details.center.lng + ' tilt:' + mydata.areas[0].tilt + ' ridge:' + mydata.areas[0].ridge[0] + ' ' + mydata.areas[0].ridge[1]);
              };
